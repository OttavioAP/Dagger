 ...
 * Get Weeks
 */
export const getWeeksWeekPost = <ThrowOnError extends boolean = false>(options: Options<GetWeeksWeekPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetWeeksWeekPostResponse, GetWeeksWeekPostError, ThrowOnError>({
        url: '/week/',
        ...options,
        headers: {
            'Content-Type': 'application/json',
