...
import type { UpdateUserUserPostData, UpdateUserUserPostResponse, UpdateUserUserPostError, GetUserByUsernameUserGetUserByUsernameGetData, GetUserByUsernameUserGetUserByUsernameGetResponse, GetUserByUsernameUserGetUserByUsernameGetError, GetUsersByTeamUserByTeamGetData, GetUsersByTeamUserByTeamGetResponse, GetUsersByTeamUserByTeamGetError, GetAllTasksTasksGetData, GetAllTasksTasksGetResponse, TaskPostTasksPostData, TaskPostTasksPostResponse, TaskPostTasksPostError, GetAllTeamsTeamsGetData, GetAllTeamsTeamsGetResponse, CreateTeamTeamsPostData, CreateTeamTeamsPostResponse, CreateTeamTeamsPostError, DeleteTeamTeamsTeamIdDeleteData, DeleteTeamTeamsTeamIdDeleteResponse, DeleteTeamTeamsTeamIdDeleteError, GetAllDagsDagGetData, GetAllDagsDagGetResponse, DagActionDagPostData, DagActionDagPostResponse, DagActionDagPostError, GetAllUserTasksUserTasksGetData, GetAllUserTasksUserTasksGetResponse, ModifyUserTaskUserTasksPostData, ModifyUserTaskUserTasksPostResponse, ModifyUserTaskUserTasksPostError, GetWeeksWeekGetData, GetWeeksWeekGetResponse, GetWeeksWeekGetError, TestUserWeekCreateWeekTestUserWeekCreatePostData, TestUserWeekCreateWeekTestUserWeekCreatePostError, ChatAgenticChatGetData, ChatAgenticChatGetError, HealthCheckHealthGetData } from './types.gen';
 ...
 */
export const getUserByUsernameUserGetUserByUsernameGet = <ThrowOnError extends boolean = false>(options: Options<GetUserByUsernameUserGetUserByUsernameGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetUserByUsernameUserGetUserByUsernameGetResponse, GetUserByUsernameUserGetUserByUsernameGetError, ThrowOnError>({
 ...
 */
export const testUserWeekCreateWeekTestUserWeekCreatePost = <ThrowOnError extends boolean = false>(options: Options<TestUserWeekCreateWeekTestUserWeekCreatePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, TestUserWeekCreateWeekTestUserWeekCreatePostError, ThrowOnError>({
        url: '/week/test_user_week_create',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
 ...
 */
export const chatAgenticChatGet = <ThrowOnError extends boolean = false>(options: Options<ChatAgenticChatGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, ChatAgenticChatGetError, ThrowOnError>({
        url: '/agentic/chat',
        ...options
    });
};
