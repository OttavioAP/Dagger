...
import type { UpdateUserUserPostData, UpdateUserUserPostResponse, UpdateUserUserPostError, GetUserByUsernameUserGetUserByUsernamePostData, GetUserByUsernameUserGetUserByUsernamePostResponse, GetUserByUsernameUserGetUserByUsernamePostError, GetUsersByTeamUserByTeamGetData, GetUsersByTeamUserByTeamGetResponse, GetUsersByTeamUserByTeamGetError, TaskActionTasksPostData, TaskActionTasksPostResponse, TaskActionTasksPostError, GetAllTasksByTeamTasksTeamIdGetData, GetAllTasksByTeamTasksTeamIdGetResponse, GetAllTasksByTeamTasksTeamIdGetError, GetAllTeamsTeamsGetData, GetAllTeamsTeamsGetResponse, CreateTeamTeamsPostData, CreateTeamTeamsPostResponse, CreateTeamTeamsPostError, DeleteTeamTeamsTeamIdDeleteData, DeleteTeamTeamsTeamIdDeleteResponse, DeleteTeamTeamsTeamIdDeleteError, DagActionDagPostData, DagActionDagPostResponse, DagActionDagPostError, GetDagsByTeamDagByTeamGetData, GetDagsByTeamDagByTeamGetResponse, GetDagsByTeamDagByTeamGetError, GetAllUserTasksUserTasksGetData, GetAllUserTasksUserTasksGetResponse, ModifyUserTaskUserTasksPostData, ModifyUserTaskUserTasksPostResponse, ModifyUserTaskUserTasksPostError, GetWeeksWeekGetData, GetWeeksWeekGetResponse, GetWeeksWeekGetError, AgenticSearchAgenticSearchGetData, AgenticSearchAgenticSearchGetResponse, AgenticSearchAgenticSearchGetError, HealthCheckHealthGetData } from './types.gen';
 ...
 * Task Action
 */
export const taskActionTasksPost = <ThrowOnError extends boolean = false>(options: Options<TaskActionTasksPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TaskActionTasksPostResponse, TaskActionTasksPostError, ThrowOnError>({
        url: '/tasks/',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const getAllTasksByTeamTasksTeamIdGet = <ThrowOnError extends boolean = false>(options: Options<GetAllTasksByTeamTasksTeamIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAllTasksByTeamTasksTeamIdGetResponse, GetAllTasksByTeamTasksTeamIdGetError, ThrowOnError>({
        url: '/tasks/{team_id}',
        ...options
    });
};
 ...
 * Get Dags By Team
 */
export const getDagsByTeamDagByTeamGet = <ThrowOnError extends boolean = false>(options: Options<GetDagsByTeamDagByTeamGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetDagsByTeamDagByTeamGetResponse, GetDagsByTeamDagByTeamGetError, ThrowOnError>({
        url: '/dag/by_team',
        ...options
    });
};
