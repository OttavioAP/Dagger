...
export type BodyTestUserWeekCreateWeekTestUserWeekCreatePost = {
    user_id: string;
};
...
export type TestUserWeekCreateWeekTestUserWeekCreatePostData = {
    body: BodyTestUserWeekCreateWeekTestUserWeekCreatePost;
    path?: never;
    query?: never;
    url: '/week/test_user_week_create';
};

export type TestUserWeekCreateWeekTestUserWeekCreatePostErrors = {
    /**
     * Validation Error
     */
    422: HttpValidationError;
...
export type TestUserWeekCreateWeekTestUserWeekCreatePostError = TestUserWeekCreateWeekTestUserWeekCreatePostErrors[keyof TestUserWeekCreateWeekTestUserWeekCreatePostErrors];

export type TestUserWeekCreateWeekTestUserWeekCreatePostResponses = {
    /**
     * Successful Response
     */
    200: unknown;
...
export type ChatAgenticChatGetData = {
    body?: never;
    path?: never;
    query: {
        query: string;
...
export type ChatAgenticChatGetErrors = {
    /**
     * Validation Error
     */
    422: HttpValidationError;
...
export type ChatAgenticChatGetError = ChatAgenticChatGetErrors[keyof ChatAgenticChatGetErrors];

export type ChatAgenticChatGetResponses = {
    /**
     * Successful Response
     */
    200: unknown;
